# Monad Blitz - On-chain Racing Game

Monad 블록체인 기반의 경마형 게임 dApp입니다. Chainlink Price Feed를 활용하여 코인 가격 변동에 따라 경주가 진행됩니다.

## 🎮 게임 개요

**Monad Blitz**는 4개의 암호화폐(BTC, ETH, MONAD, DOGE)가 경주하는 온체인 경마 게임입니다. 각 코인의 실시간 가격 변동이 말의 속도로 변환되어, 가장 먼저 결승선을 통과하거나 가장 멀리 이동한 코인이 승리합니다.
